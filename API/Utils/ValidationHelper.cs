...
namespace Tickets.API.Utils
{
    public class ValidationHelper
    {
        private static List<Intertech.Validation.Converters.IValidationConverter> _converters;
        ...
        private void DealWithProperties(PropertyInfo[] properties, ref GetValidationsParms parms, ref bool isFirstProp)
        {
